...
public class Login_PO extends Base_PO{
    ...
    public void validate_UnsuccessfulLogin_Message (){
        ...
        /*
        LoginPO'daki assertion ile ContactUsPO'daki assertion aslinda ayni
        farkili kisim ise birinde tek method var
        digerinde o tek methodu ikiye boluyor

        fark aslinda birinde alarm olarak acilmasini beklyor webelement'in
         */
    }
}
